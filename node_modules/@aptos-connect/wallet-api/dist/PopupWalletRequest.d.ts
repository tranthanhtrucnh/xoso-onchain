...
export declare function makePopupWalletRequestChallenge({ accountAddress, body, id, timestamp }: Omit<SignedPopupWalletRequest, 'clientIdentityKey' | 'signature'>): Uint8Array<ArrayBufferLike>;
