import { AccountAddress, InputGenerateTransactionPayloadData, PublicKey, RawTransaction, TransactionPayload } from '@aptos-labs/ts-sdk';
import { AccountInput, DappInfo, ExtendedNetwork } from '../../shared';
...
export declare namespace SignTransactionRequest {
    ...
    const supportedVersions: readonly [1, 2, 3, 4, 5];
