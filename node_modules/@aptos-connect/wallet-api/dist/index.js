...
function serializeSignature(serializer, value) {
  console.log("serializeSignature", value);
  ...
  } else if (value instanceof import_ts_sdk6.MultiKeySignature) {
    serializer.serializeU32AsUleb128(import_ts_sdk6.SigningScheme.MultiKey);
  } else {
...
function deserializeSignature(deserializer) {
  ...
  switch (signingScheme) {
    ...
    case import_ts_sdk6.SigningScheme.MultiKey:
      return deserializer.deserialize(import_ts_sdk6.MultiKeySignature);
    default:
      throw new Error(`Unknown signing scheme: ${signingScheme}`);
  }
}
