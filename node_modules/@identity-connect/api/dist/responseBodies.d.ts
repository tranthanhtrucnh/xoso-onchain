...
import { AccountData, AnonymousPairingData, AuthenticatedWalletData, BackendErrorResponse, BackendResponse, BaseFinalizedPairingData, GetDappData, NewPairingData, NewWalletData, PairingData, ProjectData, SerializedDate, SigningRequestData, UserData, WalletData } from './types';
// region Dapp
export type GetDappResponse = BackendResponse<{
    dapp: GetDappData;
}>;
...
export type GetPairingResponse = BackendResponse<{
    pairing: PairingData;
}>;
export type GetPairingSerializedResponse = SerializedDate<GetPairingResponse>;
export type FinalizePairingResponse = BackendResponse<{
...
export type GetUserDataResponse = BackendResponse<{
    user: UserData;
}>;
...
// endregion
//# sourceMappingURL=responseBodies.d.ts.map