...
var ACDappClient = class {
  ...
  async isIcAccount(address) {
    ...
    return icAccounts.find(
      (account) => account.address.equals(AccountAddress3.from(address))
    ) !== void 0;
  }
  async getConnectedAccounts() {
...
var ACKeylessClient = class {
  ...
  async getConnectedAccounts() {
    const serializedRequest = GetConnectedAccountsRequest2.serialize(
      this.dappInfo
    );
    const serializedResponse = await this.transport.sendRequest(serializedRequest);
  ...
  async signTransaction(args) {
    ...
    const serializedRequest = SignTransactionRequest2.serialize(
      this.dappInfo,
      normalizedArgs
    );
    const serializedResponse = await this.transport.sendRequest(serializedRequest);
  ...
  async signAndSubmitTransaction(args) {
    const serializedRequest = SignAndSubmitTransactionRequest2.serialize(
      this.dappInfo,
      args
    );
    const serializedResponse = await this.transport.sendRequest(serializedRequest);
